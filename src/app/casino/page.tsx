...
export default function GamingPage() {
  return (
    ...
    <div className=" space-y-8 pt-16 w-screen  bg-grey-600 text-grey-200">
      ...
      <Tabs defaultValue="lobby" className="w-full p-4">
        <TabsList className="h-auto flex-wrap justify-start gap-4 bg-transparent p-0">
          <TabsTrigger
            value="lobby"
            className="rounded-full bg-blue-800/60 text-white px-4 py-2 text-lg font-semibold transition-all duration-300 hover:bg-green-700 hover:text-white data-[state=active]:bg-green-800 data-[state=active]:text-white shadow-md"
          >
            Lobby
          </TabsTrigger>
          <TabsTrigger
        ...
        <TabsContent value="lobby" className="mt-8 space-y-8">
          <section>
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-lg font-semibold text-white">Stake Originals</h2>
            </div>
            <ScrollContainer>
